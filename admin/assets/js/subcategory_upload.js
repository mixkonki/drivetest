/**
 * DriveTest - Subcategory Upload JavaScript
 * Κώδικας JavaScript για τη διαχείριση του ανεβάσματος εικόνας υποκατηγορίας
 */
document.addEventListener('DOMContentLoaded', function() {
    console.log('Subcategory Upload JS loaded');
    ...
    if (subcategoryForm) {
        subcategoryForm.addEventListener('submit', function(e) {
            ...
            if (!name || !category_id) {
                e.preventDefault();
                alert('Παρακαλώ συμπληρώστε όλα τα υποχρεωτικά πεδία (Όνομα, Κατηγορία)');
            }
