...
<head>
    <meta charset="UTF-8">
    <title>Έναρξη Τεστ - DriveTest</title>
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/css/style.css">
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/css/test_start.css">
    ...
    <div class="main-container">
        ...
        <div class="test-start-container">
            ...
            <form action="generate_test.php" method="GET" id="test-form">
                ...
                <div class="form-group">
                    <label for="question_count">Αριθμός Ερωτήσεων:</label>
                    <div class="range-control">
                        <input type="range" name="question_count" id="question_count" min="5" max="50" value="20" step="5">
                        <span class="range-value" id="question_count_value">20</span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="range-control">
                        <input type="range" name="time_limit" id="time_limit" min="0" max="60" value="0" step="5">
                        <span class="range-value" id="time_limit_value">Χωρίς όριο</span>
                    </div>
                </div>
                
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">🚀 Έναρξη Τεστ</button>
                    <a href="<?= BASE_URL ?>/dashboard.php" class="btn btn-secondary">🔙 Επιστροφή</a>
                </div>
            </form>
            <?php endif; ?>
        </div>
