...
<div class="container">
    <div class="results-container">
        <h1 class="page-title"><?= $passed ? '🎉 Συγχαρητήρια!' : '📝 Αποτελέσματα Τεστ' ?></h1>
        ...
        <div class="results-actions">
            ...
            <a href="<?= BASE_URL ?>/users/dashboard.php" class="btn btn-secondary">🏠 Αρχική</a>
        </div>
